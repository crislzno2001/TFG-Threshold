...
Este Trabajo Fin de Grado nace de una pregunta que rara vez se hace en la intersección entre videojuegos e investigación psicológica: \textbf{¿puede un videojuego evaluar habilidades cognitivas sin que el jugador perciba que está siendo evaluado?} La hipótesis de la que parte Sprout es que sí, y que el medio idóneo para hacerlo es una experiencia narrativa conversacional con personajes gobernados por inteligencia artificial. El motivo es estructural: el propio Torrance, creador del instrumento más utilizado para medir la creatividad, advertía ya en 1972 que la palabra ``test'' debía evitarse delante del participante para no inhibir las respuestas creativas. Sprout lleva ese principio hasta su consecuencia última: \textbf{la evaluación no se disfraza de juego, es un juego}.

Para responder a esa pregunta, el proyecto se sitúa deliberadamente en el cruce de tres campos que rara vez coinciden en un mismo trabajo. La \textbf{psicología de la creatividad} aporta el constructo a medir ---el pensamiento divergente--- y un instrumento de referencia con casi sesenta años de vigencia, cuyas prescripciones de aplicación resultan sorprendentemente compatibles con el diseño de juegos. El \textbf{diseño de videojuegos} aporta el medio: un espacio donde el participante actúa motivado por la propia experiencia, sin la presión de rendimiento que caracteriza a la situación de examen. Y los \textbf{modelos de lenguaje a gran escala} aportan la pieza que hasta hace muy poco faltaba para unir los dos anteriores: la capacidad de sostener una conversación abierta en lenguaje natural y, al mismo tiempo, de analizar semánticamente lo que la jugadora escribe.
...
Los videojuegos ofrecen un contexto especialmente adecuado para \textbf{observar la conducta del jugador sin interrumpir la experiencia}. A diferencia de una prueba tradicional, en la que el participante sabe que está siendo evaluado, el videojuego permite integrar las tareas dentro de la ficción y convertirlas en acciones naturales del mundo de juego.
...
\begin{table}[h]
  ...
  \begin{tabular}{p{6.5cm}p{4cm}p{2.5cm}}
    ...
    \hline
    Servicios (API del modelo de lenguaje) & Coste variable por uso (tokens), consumo de desarrollo/pruebas & $\sim$10--20 \\
    \hline
    \textbf{Total estimado} & & \textbf{$\sim$6.280--6.290 €} \\
    \hline
  \end{tabular}
  \end{footnotesize}
\end{table}
...
La cifra de la tabla se estima, no se mide directamente. Sprout usa \texttt{gpt-4o-mini}, cuyo precio vigente en 2026 es de 0,15 \$ por millón de tokens de entrada y 0,60 \$ por millón de tokens de salida (OpenAI). Un turno de diálogo típico envía entre 1.000 y 1.300 tokens de entrada (system prompt del personaje, contexto del nodo, memoria y banderas) y recibe entre 100 y 150 de salida; en los nodos de reto se suma además la llamada al evaluador de creatividad (sección 5.5), de coste marginal por su límite de 70 tokens de salida. Con esas cifras, una partida completa de varios días y en torno a 150 turnos de jugador cuesta del orden de 0,03--0,05 \$ (3--5 céntimos). Multiplicado por las decenas de partidas parciales y completas jugadas durante las pruebas de los 6 meses de desarrollo, el gasto total en API se sitúa razonablemente en torno a los \textbf{10--20 €}, una cifra que debe contrastarse con el importe real del panel de facturación de OpenAI antes de cerrar la memoria, ya que esta estimación no sustituye a esa comprobación.

\subsection{Coste realista de completar el proyecto}

El presupuesto anterior refleja el coste del prototipo tal y como existe, desarrollado en solitario como TFG. Otra pregunta, distinta y pertinente, es cuánto costaría llevarlo de \textit{vertical slice} a producto terminado si se encargara en condiciones reales de mercado. Aquí conviene distinguir dos escalas de ambición muy distintas, porque el coste no crece linealmente con el contenido.

La opción \textbf{mínima} es cerrar el alcance actual como un juego pequeño pero completo: pulir el contenido de los tres días y cuatro vecinos ya diseñados, completar arte y sonido a nivel de publicación, una fase de QA sistemática, y ejecutar el protocolo de evaluación de usabilidad diseñado en el Capítulo VII. Un equipo de dos perfiles (programador/a y artista, junior o semi-senior) durante 4 meses a dedicación completa (1.280 h en total, 17--20 €/h cargado) sitúa el coste de personal en torno a 24.000 €; sumando el protocolo de evaluación (500--700 €), el consumo de API a mayor escala y la cuota de publicación en Steam (100 \$), el rango realista para esta opción es de \textbf{25.000--30.000 € adicionales}.

La opción \textbf{ambiciosa} es la que de verdad reflejaría el potencial de la premisa: un pueblo mucho más grande y personalizable en la línea de \textit{Animal Crossing}, más vecinos, más días de contenido, mecánicas adicionales (decoración, estaciones, eventos recurrentes) y una narrativa tan ramificada como la que se ha empezado a diseñar en las últimas iteraciones del grafo de diálogo. Ese alcance ya exige un equipo pequeño de estudio, no una pareja de freelance: un mínimo razonable serían 5 perfiles (dos programadores, dos artistas y un/a diseñador/a narrativo o de sonido) durante 12--18 meses a dedicación completa. Con una media de 1.700 h/año por perfil y un coste-hora cargado de 18--22 €/h, la partida de personal por sí sola se mueve entre 130.000 y 190.000 €; sumando activos de arte y audio adicionales, marketing, QA extendido y publicación, el rango total razonable para esta escala es de \textbf{180.000--250.000 €}, un orden de magnitud coherente con lo que reportan estudios indie de tamaño similar para un juego \textit{cozy}/life-sim de ambición media (rangos habituales de 50.000 a 500.000 \$ según equipo y alcance).

A cualquiera de las dos escalas se le puede sumar, como partida independiente, la \textbf{validación psicométrica} propiamente dicha (línea de trabajo futuro prioritaria, sección 7.4.2): esto exige la colaboración de un/a psicólogo/a o psicometrista con formación en el TTCT, no solo desarrolladores. Como referencia de tarifas de consultoría psicológica en España (50--80 €/h), y estimando unas 80--120 h de trabajo especializado para diseñar el estudio con el instrumento oficial, administrar el TTCT-Verbal a la muestra y analizar los resultados, esa colaboración rondaría los \textbf{6.000--10.000 €}, a los que se suma el coste de los materiales oficiales del TTCT-Verbal (manual técnico, baremos y corrección estandarizada vía Scholastic Testing Service), cuyo precio no está publicado y requeriría solicitar presupuesto directamente a STS antes de dar una cifra en firme.
...
El público objetivo principal estaría formado por jugadores de PC interesados en videojuegos independientes, narrativos y cozy. \textbf{No se trata de un juego orientado a un público masivo}, sino a un nicho concreto que valora las experiencias tranquilas, los personajes con personalidad y las decisiones con consecuencias.
...
Este capítulo detalla el diseño de Sprout: de la premisa al detalle de la mecánica diferencial. Se estructura siguiendo el camino que cualquier equipo de diseño recorre al definir un videojuego: primero el concepto y los pilares (4.1), después los espacios y el ritmo del juego (4.2), los personajes y su mapeo a las subpruebas del TTCT (4.3), la arquitectura narrativa ramificada (4.4), la operacionalización de la evaluación implícita (4.5), la mecánica diferencial de la floristería emocional (4.6), las decisiones de diseño que requieren defensa explícita (4.7) y, para cerrar, una visión integrada de la experiencia: su estructura por fases, su ritmo y el conjunto completo de mecánicas (4.8).
...
La estructura del día en cuatro momentos (mañana, mediodía, tarde, noche) ordena el ritmo de visitas: las fases diurnas son de conversación y decisión, y la noche ---no jugable de la misma manera--- es la fase de pago, en la que el pueblo procesa lo ocurrido (sección 4.8).
...
Sobre ese vocabulario se construye una gramática de ocho ramos, cada uno resultado de combinar dos flores concretas: \textit{Paz} (Sol + Acuariana), \textit{Consuelo} (Velada + Acuariana), \textit{Promesa} (Sol + Ánima), \textit{Confesión} (Crisálida + Ánima), \textit{Obsesión} (Brasa + Inquieta), \textit{Deseo oculto} (Brasa + Crisálida), \textit{Despedida} (Velada + Brasa) y \textit{Sospecha} (Inquieta + Crisálida). Las combinaciones sin receta no producen nada, lo que convierte el crafteo en un pequeño espacio de experimentación. La reacción de cada vecino a un ramo se define por personaje en un \texttt{BouquetDefinitionSO}. En el prototipo, dos ramos ---\textit{Consuelo} y \textit{Obsesión}--- tienen ya una reacción y una variación de relación completamente distintas para cada uno de los cuatro vecinos; los seis ramos restantes comparten todavía una reacción base coherente con la personalidad de cada personaje (Mochi dramático, Aster nervioso, Moth sobre-interpretando, Rix indiferente), a falta de contenido narrativo específico por combinación, extensión que queda señalada como trabajo futuro cercano. Baste aquí el ejemplo ya diferenciado del ramo de \textit{Consuelo}: hace llorar de gratitud a Mochi, calma a Aster, lo malinterpreta Moth y ofende a Rix (``no me tengas lástima'', salvo que ya confíe en la florista), de modo que regalar exige ya, al menos en parte del sistema, teoría de la mente y no solo inventario. La tabla completa se recoge en el Anexo E.
...
Un ejemplo real del proyecto, tomado directamente del nodo \texttt{Rix\_moth\_or\_flirt} (\texttt{ChoiceNodeSO}, Figura~\ref{fig:rix_moth}): Rix acaba de confesarle a la florista que le gusta, y sus dos opciones no llevan texto de botón alguno, solo una condición y un destino, \textit{``la florista le dice que a ella no le gusta o habla bien de Moth''} y \textit{``la florista tontea con Rix''}. La jugadora simplemente escribe su respuesta, y la IA decide cuál de las dos ramas describe mejor lo que ha dicho. Cada rama lleva a un \texttt{ConversationNode} distinto que fija banderas distintas al entrar ---\texttt{player\_was\_honest} y \texttt{rix\_curiosity} si la florista habla bien de Moth; \texttt{rix\_curiosity} y \texttt{unresolved\_argument} si tontea con Rix---, y ambos convergen en el mismo nodo de despedida, de modo que la ramificación de la conversación deja una consecuencia real sobre el estado narrativo y no solo una réplica distinta.

\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{rix_moth.png}
    \caption{Enter Caption}
    \label{fig:rix_moth}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{prerrequisitegates.png}
    \caption{Enter Caption}
    \label{fig:placeholder}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{graphso.png}
    \caption{Enter Caption}
    \label{fig:placeholder}
\end{figure}
...
\begin{figure}
      \centering
      \includegraphics[width=0.5\linewidth]{profile_mochi.png}
      \caption{Enter Caption}
      \label{fig:placeholder}
  \end{figure}
    \centering
  ...
  \begin{tabular}{p{1.6cm}p{5cm}p{4.6cm}p{1.6cm}}
    ...
    \hline
    Rix & Lobo punk: borde por fuera, sensible y solo por dentro; no sabe que Moth está obsesionada; puede encariñarse, encararse u odiar. & Frases cortas, secas y sarcásticas; esquiva la sinceridad. & 45 \\
    \hline
  \end{tabular}
  \end{footnotesize}
\end{table}
...
Este capítulo presenta los resultados tangibles del proyecto: el prototipo funcional entregado como \textit{vertical slice} y su aspecto final (6.1), y su publicación en itch.io como vía de distribución y de recogida informal de impresiones (6.2). \textbf{La evaluación formal con usuarios no ha llegado a ejecutarse} dentro del alcance temporal de este TFG; el protocolo diseñado para ella, junto con su justificación, se documenta en el Capítulo VII como línea de trabajo futuro, para no mezclar en este capítulo resultados obtenidos con trabajo pendiente de ejecutar.
...
Una memoria académica honesta declara con claridad sus limitaciones. Las principales limitaciones de este TFG se agrupan en tres categorías: \textbf{limitaciones de alcance metodológico, limitaciones técnicas y limitaciones de evaluación}.
...
Prompt del evaluador de creatividad (\texttt{CreativityTracker}), enviado con temperatura 0 y un límite de 70 tokens de respuesta. Los marcadores \texttt{\{...\}} se sustituyen en tiempo de ejecución: \texttt{\{situation\}} por el contexto del nodo actual (\texttt{contextForAI}), \texttt{\{countableUnit\}} por la unidad contable propia de cada personaje (por ejemplo, ``idea'' para Mochi, pero puede ser otra palabra para otros NPCs, lo que adapta el mismo prompt a dominios distintos sin duplicar código), \texttt{\{ideaDomain\}} por la definición de qué cuenta como esa unidad en la situación concreta, \texttt{\{previous\}} por la idea anterior de la jugadora (o \texttt{(none)} si es la primera) y \texttt{\{message\}} por el mensaje a evaluar. El mensaje de sistema es: \textit{``You are a precise evaluator. Output only the pipe format.''}

\begin{lstlisting}[caption={Prompt de evaluación de creatividad (original en inglés, transcrito literalmente de \texttt{CreativityTracker.cs}).},label={cod:prompt_evaluador}]
...
Previous player idea (only for ADAPTATION): "{previous, or (none)}"
...
IDEA=yes only if the message contains a genuine {countableUnit} (no for
greetings/off-topic/filler). CATEGORY = one short word for the kind of
{countableUnit}.
Reply in EXACTLY this pipe format, nothing else:
IDEA=yes|no ; ORIGINALITY=0-10 ; DETAIL=0-10 ; COHERENCE=0-10 ; EMPATHY=0-10 ;
WORLDUSE=0-10 ; RISK=0-10 ; ADAPTATION=0-10 ; CATEGORY=word
...
\begin{sidewaystable}
  \centering
  \caption{Reacciones de cada vecino a cada ramo, tal y como están implementadas en \texttt{BouquetDefinitionSO}. \textit{Consuelo} y \textit{Obsesión} tienen reacción y variación de relación distintas por vecino; los seis ramos restantes comparten aún una reacción base por personalidad (marcados con \textit{*}), pendiente de contenido narrativo específico por combinación (trabajo futuro).}
  \label{tab:reacciones_ramos}
  \begin{footnotesize}
  ...
  \begin{tabular}{p{2.6cm}p{3.4cm}p{3.4cm}p{3.6cm}p{3.8cm}}
    ...
    \hline
    Paz* & Reacciona con dramatismo. & Lo estudia con nerviosismo. & Le busca un significado oculto. & Finge que no le importa. \\
    \hline
    Consuelo & Llora de gratitud, se siente vista de verdad. & Se calma, se relaja visiblemente. & Lo interpreta de forma demasiado intensa. & Se siente compadecido y se ofende, salvo que ya confíe en la florista. \\
    \hline
    Promesa* & Reacciona con dramatismo. & Lo estudia con nerviosismo. & Le busca un significado oculto. & Finge que no le importa. \\
    \hline
    Confesión* & Reacciona con dramatismo. & Lo estudia con nerviosismo. & Le busca un significado oculto. & Finge que no le importa. \\
    \hline
    Obsesión & Reacciona con dramatismo operístico. & Se asusta de la intensidad. & Lo ama de forma peligrosa y voraz. & Se enfada de que le den algo tan cargado. \\
    \hline
    Deseo oculto* & Reacciona con dramatismo. & Lo estudia con nerviosismo. & Le busca un significado oculto. & Finge que no le importa. \\
    \hline
    Despedida* & Reacciona con dramatismo. & Lo estudia con nerviosismo. & Le busca un significado oculto. & Finge que no le importa. \\
    \hline
    Sospecha* & Reacciona con dramatismo. & Lo estudia con nerviosismo. & Le busca un significado oculto. & Finge que no le importa. \\
    \hline
  \end{tabular}
  \end{footnotesize}
\end{sidewaystable}
