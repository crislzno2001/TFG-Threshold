...
El renderizado de Sprout se construye sobre el Universal Render Pipeline (URP) de Unity 6, configurado para aprovechar el SRP Batcher y minimizar draw calls. La iluminación combina luces direccionales bakeadas para iluminación global con luces puntuales en tiempo real en los hubs interactivos, buscando un equilibrio entre rendimiento y estética cute coherente con la referencia visual del juego.

\textcolor{gray}{\textit{[Desarrollar: URP y SRP Batcher; estrategia de iluminación cute; referencias técnicas Unity Technologies 2024.]}}
