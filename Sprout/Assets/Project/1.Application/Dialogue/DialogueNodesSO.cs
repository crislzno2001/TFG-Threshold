...
namespace OpenAI.Dialogue
{
    ...
    public abstract class DialogueNodeSO : ScriptableObject
    {
        ...
        [TextArea(1, 3)]
        [Tooltip("Respuesta opcional si el jugador intenta entrar aqu� sin cumplir los requisitos")]
        public string lockedReply = "A�n no puedes avanzar por aqu�.";

        [TextArea(1, 3)]
        [Tooltip("Frase de 'bienvenida de vuelta' si el jugador RE-ENTRA en este nodo tras irse a medias " +
                 "(ej: '¡Anda! Estábamos con las recetas y te largaste...'). Vacío = usa la frase normal.")]
        public string resumeLine;

        [Header("Flags al entrar")]
        [Tooltip("Flags que se activan autom�ticamente al entrar en este nodo")]
